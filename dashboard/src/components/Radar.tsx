...
export const Radar: React.FC<RadarProps> = ({
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      glowGrad1.addColorStop(0, 'rgba(139, 92, 246, 0.07)');
      glowGrad1.addColorStop(0.5, 'rgba(79, 141, 255, 0.03)');
      ...
      // LAYER 6: Sub-10% Opacity Environmental Radar (30-second sweep)
      ...
      for (let s = 0; s < arcSteps; s++) {
        ...
        const alpha = Math.pow(stepRatio, 3) * 0.045;
